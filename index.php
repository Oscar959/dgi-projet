		...
		if(isset($_POST['nom']) ||isset($_POST['prenom']) || isset($_POST['mdp'])){
			...
			$mdp= md5($_POST['mdp']);
				 if (!empty($nom) ||  !empty($prenom) ||   !empty($mdp)){
					 $result=" SELECT id  FROM members where name LIKE '%".$nom."%' AND firstname LIKE '%".$prenom."%' AND mdp LIKE '%".$mdp."%' ";
					 $res=mysqli_query($con, $result);
					  if(mysqli_num_rows($res)>0){
							...
							$erreur= '<script>
						               setTimeout(function(){
										window.location.replace("members/centre");
									 },2000);</script>';
						  ...
						  if(mysqli_num_rows($res)>0){
								 ...
								 $erreur= '<script>
										   setTimeout(function(){
											window.location.replace("admin/centre");
										 },2000);</script>';
						  }
					 }else{
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register">Creation compte</a>
                                    </div>
                                </div>
                            </div>
                        </div>
