                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body text-secondary profile-card pt-4 d-flex flex-column align-items-center" style="font-style:italic">
                                        <?php echo '<img src="../uploads/'.$row['picture'].'" width="180px;" height="200px;" class="rounded-circle image-profile-update"; id="image" alt="image">'?>
							...
							<div class="alert alert-danger  alert-dismissable col-lg-12" id="show-w">
       ...
       function those_connected(){
		   ...
		   $.ajax({
			   ...
			   success:function(data){
				   ...
				   $("#show-w").html(data.notification);
				   //$("#show-w").delay(5000).hide(3000);
			   }
		   });
	   }
