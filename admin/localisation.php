        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<?php 
					  if(isset($_GET['user_location_by_name'])){
						  $id = $_GET['user_location_by_name'];
						  //echo $id;
						  
						  $query= $connect->query("SELECT * FROM members WHERE id= '$id'");
					...
					<div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body text-secondary profile-card pt-4 d-flex flex-column align-items-center" style="font-style:italic">
                                        <?= '<img src="../uploads/'.$picture.'" width="180px;" height="200px;" class="rounded-circle image-profile-update"; id="image" alt="image">'?>
						...
						<div class="col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                                    role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                    <h6 class="m-0 font-weight-bold text-primary" style="font-style:italic">La Localisation du travailleur</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardExample">
											...
											<div class="table-responsive">
												<table class="table table-bordered table-striped" style="font-style:italic; text-transform:capitalize;">
													...
													<tbody style="text-transform:none;">
														<td style="width:450px; height:450px;"><iframe src='https://www.google.com/maps?q=<?=$latitude;?>,<?=$longitude;?> &hl=es;z=14&output=embed'
